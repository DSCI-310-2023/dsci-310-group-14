...
all_stars_filtered <- clean_all_stars(all_stars, Year, 2011, 2015) %>% select(Year, Player) %>% 
...
```{r}
selected_combined_data <- clean_all_stars(combined_data, Year, 2011, 2015)
    filter(Player != "0") %>%
